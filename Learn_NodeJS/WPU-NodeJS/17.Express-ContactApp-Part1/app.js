// ExpressJS - Membuat ContactApp (bantuan Bootstrap)
// author @affdn-nrflh23 | 
...
app.use("/", (req, res, next) => {
	console.log(`Ini Adalah Application Level Middleware Yang Pertama`);
	next();
});

app.use("/", (req, res, next) => {
	console.log(`Ini Adalah Application Level Middleware Yang Kedua`);
	next();
});
*/
